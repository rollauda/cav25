#!/usr/bin/env python3
"""
Script de conversion Jekyll vers Docusaurus - Version Test Simple et Sûre
"""
...
def convert_file(input_file, output_file):
    """Convertit un fichier Jekyll vers Docusaurus étape par étape"""
    ...
    # 1. Convertir les images avec style
  ...
  <a href={{useBaseUrl('{img_path}')}} target="_blank" rel="noopener noreferrer">
    ...
    # 2. Convertir le tableau Jekyll spécifique
    # Chercher la ligne complète du tableau (commence par | et finit par |)
...
if __name__ == "__main__":
    input_file = "convert-md/input-clean.md"
    output_file = "convert-md/output-clean.md"
